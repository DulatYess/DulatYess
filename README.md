...
Классы в HTML разметке создаю по методологии БЭМ. Полностью кроссбраузерная адаптивная верстка поддерживающая мобильные устройства с размером от 320 пикселей. Стили могу писать с использованием препроцессора sass. При помощи миксинов прописываю адаптивные шрифты меняющие свои размеры в зависимости от размера экрана. В своих работах использую ФЛЕКСЫ и ГРИДЫ.

  Hello. I am Dulat Yesenaliev <img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30px">, self-taught front-end web developer and freelancer from Kazakhstan. My passion for software is to come up with ideas and bring them to life with elegant interfaces. I am very careful about the architecture and quality of the code I write.
I create classes in HTML markup using the BEM methodology. Fully cross-browser adaptive layout that supports mobile devices with a size of 320 pixels or more. Styles can be written using the sass preprocessor. With the help of mixins, I prescribe adaptive fonts that change their size depending on the screen size. In my work I use FLEXES and GRIDs.
